            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">تسجيل المشرفين</h3>
                  <div  style="float: left;" >
                    <button class="btn btn-block btn-primary btn-lg" style="background-color: : #3c8dbc" data-toggle="modal" data-target="#modal-default"> إضافة مشرف</button>
                  </div>
                  <div class="modal fade" id="modal-default">
                    <div class="register-box">
                      <div class="register-box-body" dir="rtl">
                        <p class="login-box-msg">إضافة مشرف جديد</p>
                        <form action="{{URL::to('admin')}}" method="post">
                          {{csrf_field()}}
                          <div class="form-group has-feedback">
                            <input type="text" class="form-control" placeholder="أسم المستخدم" name="name">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    @foreach($admins as $admin)
                      <tr>
                        <td>{{ $admin->name }}</td>
                        <td>{{$admin -> email}}</td>
                        <td><a  href="{{URL::to('client/delete/'.$admin->id)}}" class="btn btn-block btn-danger btn-sm">مسح</a></td>
                      </tr>
                      @endforeach
                                     </tbody>
                  </table>
