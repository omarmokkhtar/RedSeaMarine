                      ...
                      <tr>
                        ...
                        <td>
                          <ul style="list-style-type: none;">
                            <li><a href="{{URL::to('returnCurrentData/'.$custom->id)}}"><button class="btn btn-block btn-primary btn-sm">عرض المزيد</button></a></li>
                            <li><a href="{{URL::to('showFinReport/'.$custom->id)}}"><button class="btn btn-block btn-success btn-sm">عرض الجدول المالي</button></a></li>
                            <li><a  href="{{URL::to('archive/'.$custom->id)}}" class="btn btn-block btn-danger btn-sm" id="archive_btn">أرسل للأرشيف</a></li>
                          </ul>
                        </td>
